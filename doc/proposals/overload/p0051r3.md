<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="607">
    <tr>
        ...
        <td width="435"><span style="background-color: #FFFF00">D0051R3</span>=yy-nnnn</td>
    </tr>
    <tr>
...
This issue happens also with `reference_wrapper` and any object function that has forwarding references.
